-- PrePlate Database Schema
-- Restaurant Order, Kitchen & Sales Management System

-- Create database
CREATE DATABASE IF NOT EXISTS preplate_db;
USE preplate_db;
...
-- Food items table (updated with stock and preparation time)
...
-- Orders table (updated for restaurant workflow)
CREATE TABLE IF NOT EXISTS orders (
    ...
    estimated_preparation_time INT DEFAULT 0, -- in minutes
...
-- Password: Admin@123 (will be hashed on first run)
